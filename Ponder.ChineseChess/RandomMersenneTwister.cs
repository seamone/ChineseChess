...
{
    /// <summary>
    /// 用Mersenne Twister算法生成的随机数，摘自Math3D类库
    /// </summary>
    public class RandomMersenneTwister
    {
        ...
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="RandomMersenneTwister"/> class using the time of day in milliseconds as the seed.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RandomMersenneTwister"/> class using a given seed.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RandomMersenneTwister"/> class using a given array.
        /// </summary>
        /// <param name="init">The array for initializing keys.</param>
        public RandomMersenneTwister(int[] init)
        {
        ...
        {
            UInt64 a = genrand_int32();
            UInt64 b = genrand_int32();
            return a << 32 | b;
        }
